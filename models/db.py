...
# auth_db = DAL("mssql4://SA:M3rch2018@localhost:1433/M3rchDB?driver={ODBC Driver 17 for SQL Server}", pool_size = 0,migrate =False) # production
# auth_db = DAL('postgres://postgres:admin@localhost:5432/m3rch_root_db', pool_size = 0, migrate = False)
# auth = Auth(auth_db, cas_provider = 'http://localhost:3000/MerchERP/default/user/cas')
# auth = Auth(auth_db, cas_provider = "mssql4://SA:M3rch2018@localhost:1433/M3rchDB?driver={ODBC Driver 17 for SQL Server}", pool_size = 0) # production
# auth = Auth(auth_db, cas_provider = 'http://128.1.2.13:3000/provider/default/user/cas')

# db = DAL('postgres://postgres:admin@localhost:5432/Merch_HRM_DB', pool_size=0)
...
# for n in auth_db().select(auth_db.auth_user.ALL):        
#     # print 'insert ', n.first_name, n.last_name
